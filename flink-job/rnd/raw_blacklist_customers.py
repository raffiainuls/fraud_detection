...
def create_blacklist_customers_list():
    create_sql_blacklist_customers_list = """
    CREATE TABLE blacklist_customers_list (
        transaction_id string, 
        customer_id string, 
        amount bigint, 
        location string, 
    ...
    """
    return create_sql_blacklist_customers_list
...
blacklist_customers_list = create_blacklist_customers_list()
create_table_if_not_exists(table_env, "blacklist_customers_list", blacklist_customers_list)


def insert_into_blacklist_customers_list(table_env):
    logger.info("🔁 Inserting data into sink table...")
    table_env.execute_sql("""
    insert into blacklist_customers_list
    select 
    transaction_id 
    customer_id,
    amount, 
    ...
    bc.description
    from transactions
    left join blacklist_customer on 
"""
    )
